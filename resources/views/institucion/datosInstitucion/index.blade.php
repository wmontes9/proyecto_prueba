    ...
    <div class="container-fluid">
        <div id="datosInstitucion">
            <div class="row">
                <div class="col-lg-6">            
                    <form method="post" v-on:submit.prevent="actualizarDatosInstitucion">
                        <div class="row mt-2">
                            ...
                            <div class="col-md-6">
                                <label for="tiempo">Tiempo de constitución</label>
                                <div class="input-group">
                        ...
                        <div class="row mt-2">
                            <div class="col-12">
                                <label for="direccion">Dirección (Sede Principal)</label>
                                <div class="input-group">
                ...
                <div class="col-lg-6">   
                    <h4 class="h4" style="font-weight:450;">Actividades económicas</h4> 
