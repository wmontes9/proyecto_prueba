               ...
               <!-- <div class="card-header">
                ...
                <div class="card-body">
                    ...
                    <div class="col">
                        ...
                        <form id="target" action="{{ route('register') }}" method="POST">
                        @csrf
                            <form-wizard @on-complete="onComplete" 
                                ...
                                icon="ti-tag">
                                    <div class="form-group">
                                        ...
                                        <input type="text" v-model="nombre" name="name" id="name" class="form-control @error('name') is-invalid @enderror" placeholder="Nombres" value="{{old('name')}}" required/>
                                        
                                        <label for="last">Apellidos</label>
                                        <input type="text"v-model="apellido" name="lastname" id="last" class="form-control @error('lastname') is-invalid @enderror" placeholder="Apellidos" value="{{old('lastname')}}" required/>
                                    
                                    </div>
                                    <div class="form-group">
                                        
                                        <label for="type">Tipo de documento</label>
                                        <select v-model="tipo_documento" name="document_type" id="type" class="form-control">
                                        ...
                                        <input type="text" v-model="num_identificacion" name="number_doc" id="number_doc" class="form-control" placeholder="Documento" value="{{old('number_doc')}}"/>
                                ...
                                icon="ti-tablet">
                                    <div class=" form-group row"> 
                                        ...
                                        <input type="text" v-model="direccion" name="address" id="address" class="form-control" value="{{old('address')}}"/>

                                        <label for="phone">Teléfono</label>
                                        <input type="text" v-model="telefono" name="phone" id="phone" class="form-control" value="{{old('phone')}}"/>                                                                
                                ...
                                icon="ti-unlock">
                                    <div class="form-group row">
                                        ...
                                        <input type="email" v-model="email" name="email" id="email" class="form-control" value="{{old('email')}}"/>
                                    
                                        <label for="password" class="text-md-right">{{ __('Contraseña') }}</label>                                    
                                        <input id="password" v-model="password"  type="password" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" name="password" required autocomplete="new-password">
